...
### v2.3 - AI诊疗助手升级 (2025-09-07)
**重大升级**: 可视化决策树从假AI模板系统升级为真实AI诊疗助手

**核心改进**:
- ✅ 真实AI集成: 接入阿里云Dashscope qwen-max，35+秒真实API调用
- ✅ 诊疗模式转变: 从"问诊替代"升级为"诊疗辅助"，体现中医"一人一诊，一人一方"
- ✅ 混合智能模式: AI主导 + 模板备份的双重保障机制
- ✅ 个性化学习: AI记录医生诊疗风格，持续优化辅助效果

...
### v2.6 - 可视化决策树完善版 (2025-09-20)
**重大完善**: 可视化决策树构建器用户体验优化和思维库系统集成

**核心改进**:
- ✅ 节点UI优化: 固定220px宽度，自动文本换行，智能内容截断展开
- ✅ 编辑功能统一: 双击和右键编辑使用统一美观对话框，解决冲突和重复内容
- ✅ 思维库完善: 完整的临床模式保存功能，结构化数据提取和存储
- ✅ AI集成深化: 思维库与统一问诊服务集成，实现医生个性化AI问诊
